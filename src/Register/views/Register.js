...
export default function Login() {
  return (
    <>
      <Navbar/>
      <main>
        <section className="absolute w-full h-full  bg-dark">
          <div
            className="absolute top-2 w-full  bg-gray-900"
                  ...
                  <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
                    ...
                    <div className="relative w-full mb-3">
                      ...
                      <div className="text-center mt-6">
                        <button
                          className="text-dark active:bg-gray-700 text-sm font-bold uppercase px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 w-full"
                          type="button"
